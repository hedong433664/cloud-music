<template>
  <div class="artists-pane__container">
      ...
      <el-row :gutter="20">
        ...
        >
          <div
            ...
            @click="handleAccountDetail(item.accountId)"
          >
            <el-image
              class="cover"
            ...
            <div class="description">
              ...
              <div class="track-count">专辑：{{ item.albumSize }}</div>
            </div>
          </div>
        </el-col>
      </el-row>
...
import type { Artist } from '@/api/types/type'
